...
class Database extends Context.Service<Database, DatabaseShape>()("@telecode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@telecode/example/UserStore") {
