...
- Effect plugins import `@telecode-ai/plugin/v2/effect`, not `@telecode-ai/core`.
- Public domain values use generated `@telecode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@telecode-ai/plugin/v2/effect`.
