...
declare const TELECODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof TELECODE_CLI_NAME === "string" ? TELECODE_CLI_NAME : "telecode", {
  description: "TeleCode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
