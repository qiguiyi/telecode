import { TeleCode } from "@telecode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@telecode-ai/server/routes"
...
export const create = Effect.fn("TeleCode.create")(function* () {
  ...
  const client = yield* TeleCode.make({ baseUrl: "http://telecode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@telecode-ai/sdk-next/TeleCode") {}
