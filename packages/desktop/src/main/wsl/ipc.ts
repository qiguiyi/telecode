...
export function registerWslIpcHandlers(controller: WslServersController) {
  ...
  ipcMain.handle("wsl-servers-probe-telecode", (_event: IpcMainInvokeEvent, name: string) =>
    controller.probeTeleCode(requireWslIpcString("distro", name)),
  )
  ipcMain.handle("wsl-servers-install-telecode", (_event: IpcMainInvokeEvent, name: string) =>
    controller.installTeleCode(requireWslIpcString("distro", name)),
  )
...
function registerUnavailableWslIpcHandlers() {
  ...
  ipcMain.handle("wsl-servers-probe-telecode", unavailable)
  ipcMain.handle("wsl-servers-install-telecode", unavailable)
