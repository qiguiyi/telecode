...
import { resolveThemeVariant } from "@telecode-ai/ui/theme/resolve"
import type { DesktopTheme } from "@telecode-ai/ui/theme/types"
...
function wireWindowRecovery(win: BrowserWindow, name: string) {
  ...
  win.webContents.on("render-process-gone", (_event, details) => {
    ...
    void show(
      "TeleCode window terminated unexpectedly",
  ...
  win.on("unresponsive", () => {
    ...
    sampler.start()
    void show("TeleCode is not responding", "You can relaunch the app, open the logs, or keep waiting.", true)
  })
  win.on("responsive", () => {
