...
const releaseId = process.env.TELECODE_RELEASE
if (!releaseId) throw new Error("TELECODE_RELEASE is required")

const version = process.env.TELECODE_VERSION
if (!version) throw new Error("TELECODE_VERSION is required")
...
const macxTarGz = "telecode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "telecode-desktop-mac-arm64.app.tar.gz"
