...
import compareVideo from "../../asset/lander/telecode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/telecode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="telecode:auth" content={loggedin() ? "true" : "false"} />
