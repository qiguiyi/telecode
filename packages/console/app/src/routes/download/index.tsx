...
import desktopAppIcon from "../../asset/lander/telecode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://telecode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>telecode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g telecode-ai")}>
                <code>
                  npm i -g <strong>telecode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g telecode-ai")}>
                <code>
                  bun add -g <strong>telecode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/telecode")}>
                <code>
                  brew install <strong>anomalyco/tap/telecode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S telecode")}>
                <code>
                  paru -S <strong>telecode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask telecode-desktop")}>
                <code>
                  brew install --cask <strong>telecode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
