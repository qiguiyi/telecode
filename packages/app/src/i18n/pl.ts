export const dict = {
  ...
  "dialog.provider.telecode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.telecode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.telecodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez TeleCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w TeleCode.",
  ...
  "provider.connect.telecodeZen.line1":
    "TeleCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.telecodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.telecodeZen.visit.link": "telecode.ai/zen",
  "provider.connect.telecodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w TeleCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w TeleCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w telecode.json",
  ...
  "dialog.server.description": "Przełącz serwer TeleCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja TeleCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu TeleCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (telecode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "TeleCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla TeleCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd TeleCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy TeleCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw TeleCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania TeleCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji TeleCode.",
