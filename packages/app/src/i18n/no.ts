...
export const dict = {
  ...
  "dialog.provider.telecode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.telecode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.telecodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av TeleCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i TeleCode.",
  ...
  "provider.connect.telecodeZen.line1":
    "TeleCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.telecodeZen.visit.prefix": "Besøk ",
  "provider.connect.telecodeZen.visit.link": "telecode.ai/zen",
  "provider.connect.telecodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i TeleCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i TeleCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i telecode.json",
  ...
  "dialog.server.description": "Bytt hvilken TeleCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av TeleCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til TeleCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (telecode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at TeleCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "TeleCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør TeleCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for TeleCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan TeleCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om TeleCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan TeleCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når TeleCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av TeleCode.",
