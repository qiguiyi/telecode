export const dict = {
  ...
  "dialog.provider.telecode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.telecode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.telecodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje TeleCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u TeleCode-u.",
  ...
  "provider.connect.telecodeZen.line1":
    "TeleCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.telecodeZen.visit.prefix": "Posjeti ",
  "provider.connect.telecodeZen.visit.link": "telecode.ai/zen",
  "provider.connect.telecodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u TeleCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u TeleCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u telecode.json",
  ...
  "dialog.server.description": "Promijeni na koji se TeleCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija TeleCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku TeleCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (telecode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: TeleCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "TeleCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni TeleCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u TeleCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako TeleCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li TeleCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu TeleCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se TeleCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju TeleCode-a.",
