export const dict = {
  ...
  "dialog.provider.telecode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.telecode.tagline": "Reliable optimized models",
  "dialog.provider.telecodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by TeleCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in TeleCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.telecodeZen.line1":
    "TeleCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.telecodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.telecodeZen.visit.prefix": "Visit ",
  "provider.connect.telecodeZen.visit.link": "telecode.ai/zen",
  "provider.connect.telecodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in TeleCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in TeleCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in telecode.json",
  ...
  "dialog.server.description": "Switch which TeleCode server this app connects to.",
  ...
  "wsl.onboarding.step.telecode": "TeleCode",
  ...
  "wsl.onboarding.checkingTeleCode": "Checking TeleCode...",
  "wsl.onboarding.checkingTeleCodeIn": "Checking TeleCode in {{distro}}...",
  "wsl.onboarding.updatingTeleCode": "Updating TeleCode...",
  "wsl.onboarding.updatingTeleCodeIn": "Updating TeleCode in {{distro}}...",
  "wsl.onboarding.updateTeleCodeIn": "Update TeleCode in {{distro}}.",
  "wsl.onboarding.updateTeleCode": "Update TeleCode",
  "wsl.onboarding.telecodeReadyIn": "TeleCode is ready in {{distro}}.",
  "wsl.onboarding.telecodeReady": "TeleCode is ready.",
  "wsl.onboarding.installTeleCodeIn": "Install TeleCode in {{distro}}.",
  "wsl.onboarding.installTeleCode": "Install TeleCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen TeleCode.",
  ...
  "toast.update.description": "A new version of TeleCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the TeleCode team",
  ...
  "error.chain.checkConfig": "Check your config (telecode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, TeleCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "TeleCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "TeleCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the TeleCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for TeleCode",
  ...
  "settings.general.row.appearance.description": "Customise how TeleCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether TeleCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how TeleCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when TeleCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of TeleCode.",
