...
import { Session } from "@telecode-ai/sdk/v2/client"
...
import { toaster } from "@telecode-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@telecode-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://telecode.ai/desktop-feedback")}
      renderPanel={() =>
