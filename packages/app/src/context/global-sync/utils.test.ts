...
import type { Agent } from "@telecode-ai/sdk/v2/client"
...
describe("directoryKey", () => {
  test("normalizes slashes", () => {
    expect(String(directoryKey("C:\\Repos\\sst\\telecode"))).toBe("C:/Repos/sst/telecode")
    expect(String(directoryKey("C:/Repos/sst/telecode"))).toBe("C:/Repos/sst/telecode")
  })
