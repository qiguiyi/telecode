import type { Config, TeleCodeClient, Path, Project, ProviderAuthResponse } from "@telecode-ai/sdk/v2/client"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: TeleCodeClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: TeleCodeClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => TeleCodeClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, TeleCodeClient>()
