import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@telecode-ai/sdk/v2/client"
...
import { List, type ListRef } from "@telecode-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "telecode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.telecodeZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.telecodeZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.telecodeZen.visit.prefix")}
                <Link href="https://telecode.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.telecodeZen.visit.link")}
                </Link>
                {language.t("provider.connect.telecodeZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
