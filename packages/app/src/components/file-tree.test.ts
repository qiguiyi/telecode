...
beforeAll(async () => {
  ...
  mock.module("@telecode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@telecode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@telecode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@telecode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
