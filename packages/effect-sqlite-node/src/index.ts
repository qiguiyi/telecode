...
export const TypeId: TypeId = "~@telecode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@telecode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@telecode-ai/effect-sqlite-node/NodeSqliteClient")
