...
import { SessionTodo, SessionTodoInfo } from "@telecode-ai/schema/session-todo"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/v2/SessionTodo") {}
