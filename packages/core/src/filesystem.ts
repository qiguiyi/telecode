...
import { Entry, FileSystem, FindInput, Match } from "@telecode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@telecode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/v2/FileSystem") {}
