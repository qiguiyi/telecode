...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@telecode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/v2/ToolRegistry") {}
