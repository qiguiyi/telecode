...
import { ToolFailure } from "@telecode-ai/llm"
...
export class ConfigService extends Context.Service<ConfigService, Config>()("@telecode/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.TELECODE_WEBSEARCH_PROVIDER === "exa" || process.env.TELECODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.TELECODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("TELECODE_EXPERIMENTAL") || truthy("TELECODE_ENABLE_EXA") || truthy("TELECODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("TELECODE_ENABLE_PARALLEL") || truthy("TELECODE_EXPERIMENTAL_PARALLEL"),
