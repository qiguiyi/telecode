...
import type { Plugin } from "@telecode-ai/plugin/v2/effect"
import { PluginEvent, PluginID } from "@telecode-ai/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/v2/Plugin") {}
