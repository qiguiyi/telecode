...
import { LLMClient } from "@telecode-ai/llm"
import { RequestExecutor } from "@telecode-ai/llm/route"
...
export class LocationServiceMap extends LayerMap.Service<LocationServiceMap>()("@telecode/example/LocationServiceMap", {
