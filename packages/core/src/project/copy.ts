...
import { ProjectDirectoriesEvent } from "@telecode-ai/schema/project-directories"
import { ProjectCopy } from "@telecode-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/ProjectCopy") {}
