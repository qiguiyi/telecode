...
import type { EffectDrizzleSqlite } from "@telecode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/ProjectDirectories") {}
