...
import { Event } from "@telecode-ai/schema/event"
import type { Data, Definition, Payload } from "@telecode-ai/schema/event"
...
import { Durable } from "@telecode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@telecode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@telecode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/Event") {}
