...
Schema-first LLM core for telecode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@telecode-ai/llm"
import { OpenAI } from "@telecode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@telecode-ai/llm/providers"
