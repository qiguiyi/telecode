...
> current private `@telecode-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@telecode-ai/ai`
...
- Secondary audience: TeleCode and other durable agent runtimes
...
import { LLM } from "@telecode-ai/ai"
import { OpenAI } from "@telecode-ai/ai/providers/openai"
...
```ts
import { Message } from "@telecode-ai/ai"
...
import { LLM, Tool } from "@telecode-ai/ai"
...
TeleCode and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@telecode-ai/ai/promise"
import { OpenAI } from "@telecode-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@telecode-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@telecode-ai/ai/provider"
...
@telecode-ai/ai/promise
  Promise/AsyncIterable LLM facade

@telecode-ai/ai/schema
  serializable domain schemas

@telecode-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@telecode-ai/ai/providers/openai
@telecode-ai/ai/providers/anthropic
@telecode-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@telecode-ai/llm`                      | `@telecode-ai/ai`                                           |
...
TeleCode should migrate to `generateTurn` / `streamTurn`, preserving its durable
