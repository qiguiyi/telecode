...
import type { AssistantMessage, FilePart, UserMessage } from "@telecode-ai/sdk/v2"
...
import { TELECODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useTeleCodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.TELECODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
