...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips telecode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-telecode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-telecode-directory")).toBeNull()
      expect(result.get("x-telecode-workspace")).toBeNull()
