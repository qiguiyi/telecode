...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/telecode.git")).toEqual({ owner: "sst", repo: "telecode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/telecode")).toEqual({ owner: "sst", repo: "telecode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/telecode.git")).toEqual({ owner: "sst", repo: "telecode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/telecode")).toEqual({ owner: "sst", repo: "telecode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/telecode.git")).toEqual({ owner: "sst", repo: "telecode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/telecode")).toEqual({ owner: "sst", repo: "telecode" })
})
