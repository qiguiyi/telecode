...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders TELECODE_CALLER", () => {
    process.env["TELECODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode TELECODE_CALLER", () => {
    process.env["TELECODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown TELECODE_CALLER", () => {
    process.env["TELECODE_CALLER"] = "unknown"
