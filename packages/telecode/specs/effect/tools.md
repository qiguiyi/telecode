...
Practical reference for the current tool-migration state in `packages/telecode`.
...
Tool tests should use the existing Effect helpers in `packages/telecode/test/lib/effect.ts`:
