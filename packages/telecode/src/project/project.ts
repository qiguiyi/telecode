...
import { ProjectDirectoryTable, ProjectTable } from "@telecode-ai/core/project/sql"
...
import { which } from "@telecode-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.TELECODE_FAKE_VCS)
