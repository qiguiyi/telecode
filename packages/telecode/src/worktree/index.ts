...
import { path } from "@telecode-ai/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@telecode-ai/core/project"
...
import { WorktreeEvent } from "@telecode-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `telecode/${name}`
