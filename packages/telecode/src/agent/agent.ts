...
import { AbsolutePath, type DeepMutable } from "@telecode-ai/core/schema"
...
import { Reference } from "@telecode-ai/core/reference"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".telecode", "plans", "*.md")]: "allow",
