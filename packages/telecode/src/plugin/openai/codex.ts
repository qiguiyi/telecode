...
<html>
  <head>
    <title>TeleCode - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>TeleCode - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "telecode"
      output.headers["User-Agent"] = `telecode/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
