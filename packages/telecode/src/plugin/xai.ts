...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=telecode` lets xAI attribute telecode-originated
...
<html>
  <head>
    <title>TeleCode - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>TeleCode - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire telecode process. Matches the silent-
