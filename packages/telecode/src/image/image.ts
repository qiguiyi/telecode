...
export class Service extends Context.Service<Service, Interface>()("@telecode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __TELECODE_PHOTON_WASM_PATH?: string }).__TELECODE_PHOTON_WASM_PATH =
