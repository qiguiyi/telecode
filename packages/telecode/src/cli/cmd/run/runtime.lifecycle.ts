...
import { openEditor } from "@telecode-ai/tui/editor"
import { registerTeleCodeKeymap } from "@telecode-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerTeleCodeKeymap(keymap, renderer, input.tuiConfig)
