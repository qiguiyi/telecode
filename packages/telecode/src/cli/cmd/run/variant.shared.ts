...
//
// The saved variant persists across sessions in ~/.local/state/telecode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@telecode/RunVariant") {}
