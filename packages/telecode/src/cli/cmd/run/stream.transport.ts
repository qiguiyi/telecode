...
import type { Event, GlobalEvent, TeleCodeClient } from "@telecode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@telecode/RunStreamTransport") {}
