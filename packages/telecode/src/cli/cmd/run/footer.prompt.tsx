...
import { normalizePromptContent } from "@telecode-ai/tui/editor"
...
import { TELECODE_BASE_MODE, useBindings } from "@telecode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close TeleCode" } satisfies SlashOption,
    ]
