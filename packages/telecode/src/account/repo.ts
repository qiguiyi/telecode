...
import { AccountStateTable, AccountTable } from "@telecode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/AccountRepo") {}
