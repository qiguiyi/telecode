...
import { httpClient, path } from "@telecode-ai/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/SkillDiscovery") {}
