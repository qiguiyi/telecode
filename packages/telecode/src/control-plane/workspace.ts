...
import { EventSequenceTable, EventTable } from "@telecode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@telecode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        TELECODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        TELECODE_WORKSPACE_ID: config.id,
        TELECODE_EXPERIMENTAL_WORKSPACES: "true",
