...
import { PermissionV1 } from "@telecode-ai/core/v1/permission"
import { Slug } from "@telecode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@telecode-ai/llm"
...
import { PartTable, SessionTable } from "@telecode-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@telecode-ai/core/schema"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProviderV2 } from "@telecode-ai/core/provider"
import { ModelV2 } from "@telecode-ai/core/model"
import { SessionMessageID } from "@telecode-ai/schema/session-message-id"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".telecode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@telecode/Session") {}
