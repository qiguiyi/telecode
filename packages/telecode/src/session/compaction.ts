...
import { buildPrompt } from "@telecode-ai/core/session/compaction"
import { SessionCompactionEvent } from "@telecode-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/SessionCompaction") {}
