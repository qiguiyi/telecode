import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@telecode-ai/llm"
...
// Move this extraction into @telecode-ai/llm when Copilot is handled by the native runtime.
