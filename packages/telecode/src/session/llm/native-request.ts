import type { JsonSchema, LLMRequest, ProviderMetadata } from "@telecode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@telecode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @telecode-ai/llm request objects from telecode's session/AI SDK-shaped data.
  return LLM.request({
