...
import { SessionStatusEvent } from "@telecode-ai/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/SessionStatus") {}
