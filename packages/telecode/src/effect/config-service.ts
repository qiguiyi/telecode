 ...
 *   "@telecode/ServerAuthConfig",
 *   {
 *     password: Config.string("TELECODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("TELECODE_SERVER_USERNAME").pipe(Config.withDefault("telecode")),
 *   },
 * ) {}
 *
