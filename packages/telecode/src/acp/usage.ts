...
import type { AssistantMessage as TeleCodeAssistantMessage, Message } from "@telecode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<TeleCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<TeleCodeAssistantMessage, "role"> &
  Partial<Pick<TeleCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@telecode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@telecode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@telecode/ACPUsage") {}
