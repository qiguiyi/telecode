...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@telecode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@telecode/ACPDirectory") {}
