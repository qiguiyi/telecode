...
import type * as SDK from "@telecode-ai/sdk/v2"
...
import { SessionShareTable } from "@telecode-ai/core/share/sql"
...
const disabled = process.env["TELECODE_DISABLE_SHARE"] === "true" || process.env["TELECODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@telecode/ShareNext") {}
