...
import { makeApi } from "@telecode-ai/protocol/api"
import { LocationMiddleware } from "@telecode-ai/server/location"
import { SessionLocationMiddleware } from "@telecode-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("telecode-root")
...
export const InstanceHttpApi = HttpApi.make("telecode-instance")
...
export const TeleCodeHttpApi = HttpApi.make("telecode")
