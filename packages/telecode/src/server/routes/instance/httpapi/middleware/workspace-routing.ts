...
>()("@telecode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@telecode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.TELECODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.TELECODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-telecode-directory"] || process.cwd()
}
