...
import { IconTeleCode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "telecode/session/message-v2"
import type { Message } from "telecode/session/message"
import type { Session } from "telecode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.telecode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.telecode_name}>
                    <IconTeleCode width={16} height={16} />
                  </div>
