...
Crear `.telecode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración TeleCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su TeleCode [config](/docs/config):
...
- Por proyecto: `.telecode/commands/`
...
telecode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
