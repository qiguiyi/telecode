...
Agentferdigheter lar TeleCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går TeleCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
TeleCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `telecode.json`:
