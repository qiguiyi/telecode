...
Brug den til at bygge integrasjoner og kontrollere telecode programmatisk.
...
Opret en forekomst av telecode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `telecode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av telecode, kan du oprete en klientforekomst for at koble til den:
