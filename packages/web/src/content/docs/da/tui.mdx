---
title: TUI
description: Brug af TeleCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

TeleCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre TeleCode starter TUI for den nuværende mappe.
...
Når du bruger TeleCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til TeleCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut TeleCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `telecode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe TeleCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `telecode.default`.
