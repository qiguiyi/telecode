---
title: TUI
description: Bruke telecode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

TeleCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre TeleCode starter TUI for gjeldende katalog.
...
Når du bruker TeleCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til TeleCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt TeleCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `telecode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge TeleCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `telecode.default`.
