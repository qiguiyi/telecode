...
Opprett `.telecode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom TeleCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i TeleCode [config](/docs/config):
...
- Per prosjekt: `.telecode/commands/`
...
TeleCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
