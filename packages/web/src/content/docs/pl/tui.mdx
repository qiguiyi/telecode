---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala telecode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

telecode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie telecode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI telecode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do telecode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij telecode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `telecode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo TeleCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `telecode.default`.
