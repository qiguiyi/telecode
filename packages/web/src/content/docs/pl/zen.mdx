---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez TeleCode.
---
...
TeleCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół TeleCode.

Zen działa jak każdy inny dostawca w TeleCode. Logujesz się do TeleCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z TeleCode.
:::
...
TeleCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

TeleCode Zen działa jak każdy inny dostawca w TeleCode.

1. Logujesz się do **<a href={console}>TeleCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz TeleCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji TeleCode używa formatu
`telecode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`telecode/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w TeleCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w TeleCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w TeleCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w TeleCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w TeleCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w TeleCode także dowolnego innego dostawcy.
