...
Utwórz `.telecode/commands/test.md`:
...
Możesz zdefiniować polecenia w `telecode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji telecode:
...
- Globalnie: `~/.config/telecode/commands/`
- Na projekt: `.telecode/commands/`
...
telecode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
