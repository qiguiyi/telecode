...
`.telecode/commands/test.md` oluştur:
...
telecode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

telecode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/telecode/commands/`
- Proje başına: `.telecode/commands/`
...
telecode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
