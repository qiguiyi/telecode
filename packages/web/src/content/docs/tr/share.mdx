---
title: Paylasim
description: telecode konusmalarini genel baglantilarla paylasin.
---

telecode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda telecode:
...
telecode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak telecode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `telecode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda telecode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
