---
title: Özel Araçlar
description: LLM'un telecode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. telecode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.telecode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/telecode/tools/` içine yerleştirerek.
