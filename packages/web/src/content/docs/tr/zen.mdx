---
title: Zen
description: telecode tarafından sağlanan seçilmiş modeller listesi.
---
...
TeleCode Zen, TeleCode ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, TeleCode'daki diğer sağlayıcılar gibi çalışır. TeleCode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve TeleCode kullanmak için buna ihtiyacınız yoktur.
...
:::tip
TeleCode ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
TeleCode Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

TeleCode Zen, TeleCode'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>TeleCode Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, TeleCode Zen'i seçin ve API anahtarınızı yapıştırın.
...
TeleCode yapılandırmanızdaki [model id](/docs/config/#models) `telecode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `telecode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için TeleCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için TeleCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için TeleCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için TeleCode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için TeleCode'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
TeleCode Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca TeleCode ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
