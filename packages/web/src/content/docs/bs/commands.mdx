...
Kreiraj `.telecode/commands/test.md`:
...
Možete dodati prilagođene komande kroz TeleCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom TeleCode [config](/docs/config):
...
- Globalno: `~/.config/telecode/commands/`
- Po projektu: `.telecode/commands/`
...
TeleCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
