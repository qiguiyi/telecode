---
title: TUI
description: Korištenje korisničkog interfejsa TeleCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

TeleCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje TeleCode pokreće TUI za trenutni direktorij.
...
Kada koristite TeleCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u TeleCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz TeleCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `telecode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo TeleCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `telecode.default`.
