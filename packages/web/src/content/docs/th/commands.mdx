...
สร้าง `.telecode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ TeleCode:
...
- ระดับผู้ใช้ (Global): `~/.config/telecode/commands/`
- ระดับโปรเจ็กต์: `.telecode/commands/`
...
TeleCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
