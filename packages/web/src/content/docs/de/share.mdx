---
title: Teilen
description: Teile TeleCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu TeleCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht TeleCode Folgendes:
...
TeleCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt TeleCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`telecode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du telecode in deiner Organisation einsetzt.
