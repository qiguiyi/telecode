---
title: SDK
description: Typsicherer JS-Client fuer den telecode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das telecode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und telecode programmatisch steuern.
...
Erstelle eine telecode-Instanz:
...
`telecode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn telecode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
