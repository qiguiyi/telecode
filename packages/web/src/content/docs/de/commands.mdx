...
Erstellen Sie `.telecode/commands/test.md`:

```md title=".telecode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die TeleCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem TeleCode [config](/docs/config):

```json title="telecode.jsonc" {4-12}
{
...
- Global: `~/.config/telecode/commands/`
- Pro Projekt: `.telecode/commands/`

```markdown title="~/.config/telecode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".telecode/commands/component.md"
---
...
```md title=".telecode/commands/create-file.md"
---
...
```md title=".telecode/commands/analyze-coverage.md"
---
...
```md title=".telecode/commands/review-changes.md"
---
...
```md title=".telecode/commands/review-component.md"
---
...
TeleCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
