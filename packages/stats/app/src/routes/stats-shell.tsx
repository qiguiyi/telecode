import telecodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/telecode",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star TeleCode on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "telecode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://telecode.ai/">
            <strong>Try TeleCode</strong>
          </a>
          <button
...
function TeleCodeMark() {
  return (
    <svg data-slot="telecode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://telecode.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://telecode.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@telecode.ai", label: "Contact us" },
    { href: "https://telecode.ai/discord", label: "Community" },
    { href: "https://x.com/telecode", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://telecode.ai" aria-label="TeleCode home">
          <TeleCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={telecodeWordmarkDark} alt="TeleCode" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">TeleCode Newsletter</h2>
            <p>
