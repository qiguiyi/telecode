...
npm i -g telecode-ai@latest        # o bun/pnpm/yarn
scoop install telecode             # Windows
choco install telecode             # Windows
brew install anomalyco/tap/telecode # macOS y Linux (recomendado, siempre al día)
brew install telecode              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S telecode            # Arch Linux (Stable)
paru -S telecode-bin               # Arch Linux (Latest from AUR)
mise use -g telecode               # cualquier sistema
nix run nixpkgs#telecode           # o github:anomalyco/telecode para la rama dev más reciente
```
...
TeleCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/telecode/releases) o desde [telecode.ai/download](https://telecode.ai/download).
...
1. `$TELECODE_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.telecode/bin` - Alternativa por defecto
...
TeleCode incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://telecode.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar TeleCode, [**ve a nuestra documentación**](https://telecode.ai/docs).

### Contribuir

Si te interesa contribuir a TeleCode, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en TeleCode

Si estás trabajando en un proyecto basado en TeleCode y usas "telecode" como parte del nombre, por ejemplo, "telecode-dashboard" u "telecode-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de TeleCode y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/telecode) | [X.com](https://x.com/telecode)
