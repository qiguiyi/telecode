...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/telecode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/telecode...\n")
...
console.log("Fetching npm all-time downloads for telecode-ai...\n")
const npmDownloads = await fetchNpmDownloads("telecode-ai")
