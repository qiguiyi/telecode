...
Generates UPCOMING_CHANGELOG.md by running the telecode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for telecode run (default: low)
      --quiet            Suppress telecode command output unless it fails
