...
- PR #10018: https://github.com/anomalyco/telecode/pull/10018
- PR #12935: https://github.com/anomalyco/telecode/pull/12935

## Do Not Translate (Locale Additions)

- `TeleCode` (preserve casing in prose; keep `telecode` only in commands, package names, paths, or code)
- `TeleCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
