...
Use this folder for locale-specific translation guidance that supplements `.telecode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/telecode/pull/12345

## Do Not Translate (Locale Additions)

- `TeleCode` (preserve casing)
