...
- PR #13942: https://github.com/anomalyco/telecode/pull/13942

## Do Not Translate (Locale Additions)

- `TeleCode` (preserve casing in prose; keep `telecode` only when it is part of commands, package names, paths, or code)
- `TeleCode Zen`
- `TeleCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `telecode` in prose when referring to the product name; use `TeleCode`
