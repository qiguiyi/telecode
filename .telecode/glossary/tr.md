...
- PR #15835: https://github.com/anomalyco/telecode/pull/15835

## Do Not Translate (Locale Additions)

- `TeleCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `telecode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `TeleCode` in prose, `telecode` only for exact technical identifiers
...
- Avoid changing `telecode` to `TeleCode` inside commands, URLs, package names, or code literals
